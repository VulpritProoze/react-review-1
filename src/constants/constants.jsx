...
export const USER_DETAILS = [
  {
    ...
    profession: ["Sculptor", "Traditional Painter", "Theatrical Dancer"],
    region: "Cebu",
    country: "Philippines",
    profile_description:
      "I am an aspiring artist from Cebu City who wishes to paint colors as if I'm painting a canvas across the universe.",
    following_count: 99,
    followers_count: 120,
    friends: 9,
  },
...
export const USER_ARTWORKS = [
  {
    title: "Lost in Abyss",
    genre: "Painting",
    type: "Physical",
    description: "Lorem ipsum dolor set amit. Lorem ipsum dolor set amit. ",
  },
  {
    title: "Intermingled Shadows",
    genre: "Dance",
    type: "Performance",
    description: "Lorem ipsum dolor set amit. Lorem ipsum dolor set amit. ",
  },
  {
    title: "Statically Flawed",
    genre: "Sculpture",
    type: "Physical",
    description: "Lorem ipsum dolor set amit. Lorem ipsum dolor set amit. ",
  },
  {
    title: "Sunlit Meadows",
    genre: "Painting",
    type: "Physical",
    description: "Lorem ipsum dolor set amit. Lorem ipsum dolor set amit. ",
  },
  {
    title: "Phantom of the Opera Revision",
    genre: "Dance",
    type: "Performance",
    description: "Lorem ipsum dolor set amit. Lorem ipsum dolor set amit. ",
  },
  {
    title: "Da Vinci Mimicry",
    genre: "Sculpture",
    type: "Physical",
    description: "Lorem ipsum dolor set amit. Lorem ipsum dolor set amit. ",
  },
